		...
		while( !input.equals("q") ) {
			...
			if(Integer.parseInt(input) == 1) { // Criar aviso
				...
				try {
					...
					System.err.println("N�o foi poss�vel criar o aviso.");
					e.printStackTrace();
				}
				...
				try {
					...
					System.err.println("N�o foi poss�vel apagar o aviso.");
					e.printStackTrace();
				}
			...
			} else if (Integer.parseInt(input) == 4) { // Criar padr�o de inatividade
				Scanner sc4 = new Scanner(System.in);
				
			} else if (Integer.parseInt(input) == 5) { // Criar padr�o de atividade
